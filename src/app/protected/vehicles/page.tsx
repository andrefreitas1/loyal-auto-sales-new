...
export default function VehicleList() {
  ...
  const fetchVehicles = async () => {
    try {
      ...
      const processedData = data.map((vehicle: Vehicle) => ({
        ...vehicle,
        mileage: vehicle.mileage || 0,
        purchasePrice: vehicle.purchasePrice || 0,
        salePrice: vehicle.salePrice || 0,
        saleInfo: vehicle.saleInfo ? {
          ...vehicle.saleInfo,
          salePrice: vehicle.saleInfo.salePrice || 0
        } : null
      }));
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      {vehicle.status === 'sold' ? (
                        <span>Valor da Venda: ${(vehicle.saleInfo?.salePrice || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                      ) : (
                        <span>Valor de Compra: ${vehicle.purchasePrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                      )}
                    </div>
                  </div>
                </div>
