      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Clientes Interessados</h1>
            <Link
              href="/protected/customers/new"
              className="w-full sm:w-auto text-center bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-4 sm:px-6 rounded-lg text-sm sm:text-base"
            >
              Novo Cliente
            </Link>
          </div>
          ...
          {session?.user?.role === 'admin' && (
            <div className="mb-6">
              <select
                ...
                className="w-full text-sm sm:text-base px-3 sm:px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              >
              ...
              >
                <div className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-4">
                    <div>
                      <h2 className="text-lg sm:text-xl font-semibold text-gray-900">{customer.fullName}</h2>
